---
title: A few key points from "Preventing Sexual Violence —A
  Behavioral Problem Without a Behaviorally-Informed Solution"
author: Seth Green
date: '2024-03-25'
...
It is now available as a [preprint](https://osf.io/preprints/psyarxiv/xgbzj) and will be published in the next issue of [*Psychological Science in the Public Interest*](https://journals.sagepub.com/home/PSI)*.*

I wrote the meta-analysis/quantitative results section so this post mostly focuses on that, along with a few EA-specific remarks.

Is violence against women and girls an '[EA issue](https://twitter.com/EffectvAltruism/status/1752008212071493684)?' I think it is a good candidate, as do others: see [the Women and Girls Fund at The Life You Can Save](https://www.thelifeyoucansave.org/cause-funds/help-women-girls-fund/), [Akhil](https://forum.effectivealtruism.org/users/akhil-bansal-1)'s post on [Violence against women and girls as a cause area](https://forum.effectivealtruism.org/posts/majcwf7i8pW8eMJ3v/new-cause-area-violence-against-women-and-girls), and Charity Entrepreneurship's [report on violence against women and girls](https://9475dbf4-555e-4808-9886-5f8ee815cc82.usrfiles.com/ugd/9475db_66904fd043c14d5399d1fc4174a13462.pdf) (see [discussion here](https://forum.effectivealtruism.org/posts/2Nnu9ykixiqG2mMit/#Mass_media_to_prevent_violence_against_women1)). Either way I think the results are worth sharing.

All unattributed quotes are from the paper itself.
...
![](images/clipboard-452603583.png)
...
![](images/clipboard-2789718618.png)
...
The one cost-benefit analysis that I can remember is of the [SASA! program in Uganda](https://link.springer.com/article/10.1186/s12916-014-0122-5), which estimated they could [prevent a single instance of IPV for \$486 on average](https://link.springer.com/article/10.1186/s12889-016-2883-6?fromPaywallRec=false). Unfortunately, this study has just 4 clusters in treatment and 4 in control, which is pretty darn underpowered. However, for anyone looking to work in this field, this is probably a good baseline estimate.

If a funder were asking me what opportunities are out there, I would say we need more basic research, i.e. randomized evaluations of the sorts of behavioral interventions we propose.
